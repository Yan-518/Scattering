...
def pol_vec_br(theta_i, theta_s, eq_azi, inc_polar):
    """
    :param theta_i:
    :param eq_azi:
    :param polarization:
...
def Br_bi(k, kr, theta_i, theta_s, theta_eq, eq_azi, u_10, fetch, spec_name, polarization, inc_polar):
    M = pol_vec_br(theta_i, theta_s, eq_azi, inc_polar)
